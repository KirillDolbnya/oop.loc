...
use App\views\services\GetAllUsers;
use App\views\services\CheckLogin;


$getUsers = new GetAllUsers();
$users = $getUsers->getAllUsers('users');
...
<!--    <body class="mod-bg-1 mod-nav-link">-->
        ...
        <main id="js-page-content" role="main" class="page-content mt-3">
            ...
            <div class="row">
                <div class="col-xl-12">
                    <?php if ($checkRole->checkrole($_SESSION['auth_user_id'])) {?>
                            ...
                            <div class="d-flex flex-row align-items-center">
                                ...
                                <div class="info-card-text flex-1">
                                    <a href="javascript:void(0);" class="fs-xl text-truncate text-truncate-lg text-info" data-toggle="dropdown" aria-expanded="false">
                                        ...
                                        <?php if ($user['id'] == $_SESSION['auth_user_id'] || $checkRole->checkrole($_SESSION['auth_user_id']) == true){ ?>
